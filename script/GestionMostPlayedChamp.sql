-- Création de la table "PlayedChamp" afin de pouvoir stocker les 3 champions les plus joué pour chaque joueurs de la compétition.
...
-- Fonction permettant de donner les 3 champions les plus joués par joueurs et de les insérer dans la table "PlayedChamp"
...
-- Trigger permettant d'exécuter la fonction "MostPlayedChampByPlayer" après l'insertion de tuple dans la table "Historique_Matchs".
